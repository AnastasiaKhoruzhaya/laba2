...
namespace laba2
{
    class Program
    {
        static void Main(string[] args)
        {
                ...
                string str1 = "help"; string str2 = "me";
                ...
                str1 = str1.Insert(0, "i don't know ");
                ...
                StringBuilder strB = new StringBuilder("My name is Nastya");//работа со строкой через StringBuilder
                ...
                string[] strarray = { "My", "name", "is", "Nastya" };
                for (int q = 0; q < 4; q++)
                {
                ...
                (int, int, int, char) LocalF(int[] arr, string strF)
                {
                    return (arr.Max(), arr.Min(), arr.Sum(), strF[1]);
                }
